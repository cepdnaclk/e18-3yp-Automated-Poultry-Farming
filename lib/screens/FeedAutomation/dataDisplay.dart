...
class DataDisplayPage extends StatefulWidget {
  final String info, flockID;
   DataDisplayPage({Key? key, required this.info, required this.flockID}) : super(key: key);

  @override
  State<DataDisplayPage> createState() => _FCRScreenState();
}

class _FCRScreenState extends State<DataDisplayPage> with TickerProviderStateMixin {
  String startDate = '';
  String strainType = '';
