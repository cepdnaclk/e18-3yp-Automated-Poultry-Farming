...
class DeleteAutomatedFeed extends StatefulWidget {
  ...
  @override
  State<DeleteAutomatedFeed> createState() => _DeleteAutomatedFeedState();
}

class _DeleteAutomatedFeedState extends State<DeleteAutomatedFeed> {
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    // print(date);
                    await deleteData(widget.id_flock,
